        ...
        <div className="min-h-screen bg-[#0f172a] pt-32 md:pt-28 pb-20">
            <div className="mx-auto max-w-screen-xl px-4">
                ...
                <div className="flex items-center gap-4 mb-10">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black text-white tracking-tight">Order History</h1>
                </div>
                ...
                {orders.length === 0 ? (
                    <div className="text-center py-20 bg-[#1e293b] rounded-3xl border border-gray-700/50 shadow-xl">
                        ...
                        <p className="text-gray-400 font-medium tracking-wide">You haven't placed any orders yet.</p>
                    </div>
                ) : (
                    <div className="space-y-8">
                        {orders.map((order) => (
                            <div key={order._id} className="bg-[#1e293b] rounded-3xl border border-gray-700/50 overflow-hidden shadow-2xl transition-all hover:border-[#12bb9c]/30">
                                ...
                                <div className="p-6 border-b border-gray-700/50 flex flex-wrap justify-between items-center gap-6 bg-gray-800/30">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest leading-none mb-1">Order Ref</p>
                                    ...
                                    <div className="flex gap-3">
                                        <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter ${order.isPaid ? 'bg-[#12bb9c]/10 text-[#12bb9c]' : 'bg-orange-500/10 text-orange-500 border border-orange-500/20'}`}>
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {order.cartItems.map((item) => (
                                            <div key={item._id} className="group flex gap-4 items-center bg-[#0f172a] p-4 rounded-2xl border border-gray-700/30 transition-colors hover:border-[#12bb9c]/40">
                                ...
                                <div className="px-8 py-5 bg-gray-900/40 border-t border-gray-700/50 flex flex-wrap justify-between items-center gap-4">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className="text-[#12bb9c] font-black text-2xl">
                                            {order.totalOrderPrice} <span className="text-xs ml-1 font-bold">EGP</span>
                                        </p>
                                    </div>
                                </div>
