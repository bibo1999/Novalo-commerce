          ...
          <div className="hidden lg:flex grow justify-center">
            <ul className="flex items-center gap-10 list-none m-0 p-0">
              ...
              <li onMouseEnter={() => setActiveMenu("categories")}>
                <div
                  className={`text-[13px] uppercase tracking-wider font-semibold transition flex items-center gap-1 cursor-pointer ${activeMenu === "categories" ? "text-[#12bb9c]" : "hover:text-[#12bb9c]"}`}
                >
                  Categories
