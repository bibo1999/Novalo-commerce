      ...
      <div className="max-w-screen-xl px-4 mx-auto py-4">
        <div className="flex items-center justify-between relative">
          ...
          <div className="hidden lg:flex grow justify-center">
            <ul className="flex items-center gap-10 list-none m-0 p-0">
              ...
              <li onMouseEnter={() => setActiveMenu("categories")}>
                <Link
                  href="/categories"
                  className={`text-[13px] uppercase tracking-wider font-semibold transition flex items-center gap-1 cursor-pointer ${
          ...
          <div className="flex items-center space-x-2 shrink-0">
            ...
            <div className="relative">
              ...
              {activeMenu === "user" && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl overflow-hidden z-50 border border-gray-200 text-gray-800">
                  <div className="bg-gray-50 px-4 py-2 text-[10px] text-gray-400 uppercase font-bold tracking-widest border-b">
                    Settings
                  </div>
                  {userData ? (
                    <>
                      ...
                      <button
                        ...
                        className="cursor-pointer w-full text-left px-4 py-2 hover:bg-red-50 text-red-600 border-t font-semibold transition"
                      >
                        Sign Out
                      </button>
                    </>
            ...
            >
              <i
                className={`fa-solid ${activeMenu === "mobile" ? "fa-xmark" : "fa-bars"} text-xl`}
              ></i>
            </button>
          </div>
        </div>
        ...
        {/* MOBILE MENU CONTENT */}
        <div
          className={`lg:hidden overflow-hidden transition-all duration-300 ease-in-out ${activeMenu === "mobile" ? "max-h-screen opacity-100 py-6" : "max-h-0 opacity-0"}`}
        >
            ...
            {!userData && (
              <div className="flex flex-col space-y-3 pt-2">
                <Link
                  href="/login"
                  onClick={closeAll}
                  className="text-center bg-[#12bb9c] py-3 rounded-lg font-bold"
                >
                  Login
                </Link>
                <Link
                  href="/register"
                  onClick={closeAll}
                  className="text-center border border-white py-3 rounded-lg"
                >
                  Register
                </Link>
              </div>
        ...
        {activeMenu === "categories" && (
          <div
            className="absolute left-0 top-full w-full bg-white text-gray-800 shadow-2xl border-t border-gray-100 hidden lg:block"
          ...
          >
            <div className="max-w-screen-xl mx-auto grid grid-cols-12 min-h-95">
              <div className="col-span-3 border-r border-gray-100 p-6 bg-gray-50/50">
                <h3 className="font-bold text-[#001f3f] text-[11px] uppercase mb-4 tracking-widest opacity-60">
                  Categories
                </h3>
              ...
              <div className="col-span-4 p-8 flex items-center justify-center">
                <Link
                  href={`/categories/${hoveredCategory?._id}`}
                  onClick={closeAll}
                  className="relative w-full h-70 group/img overflow-hidden rounded-2xl shadow-lg"
                >
                  <Image
                    src={hoveredCategory?.image || "/placeholder.png"}
                    fill
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-[#001f3f]/80 to-transparent flex flex-col justify-end p-6">
                    <span className="text-white text-xs uppercase tracking-[0.2em] font-bold mb-1 opacity-80">
                      Explore
                    </span>
